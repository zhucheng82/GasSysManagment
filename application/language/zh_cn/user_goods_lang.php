...
//总台控制提示语
$lang['goods_attr_admin_control']	 			= '该值由总台控制，不能修改哦~';
...
$lang['store_goods_index_new_goods']			= '新增洗件';
$lang['store_goods_index_add_goods']			= '发布新洗件';
...
$lang['store_goods_index_goods_name']	 		= '洗件名称';
$lang['store_goods_index_goods_name_help']	 	= '洗件标题名称长度至少3个字符，最长50个汉字';
$lang['store_goods_index_goods_class']	 		= '洗件分类';
$lang['store_goods_index_brand']	 			= '品牌';
$lang['store_goods_index_price']	 			= '价格';
$lang['store_goods_index_stock']				= '库存';
$lang['store_goods_index_goods_limit']			= '您已经达到了添加洗件的上限';
$lang['store_goods_index_goods_limit1']			= '个，如果您想继续增加洗件，请到“店铺设置”升级店铺等级';
$lang['store_goods_index_pic_limit']			= '您已经达到了图片空间的上限';
$lang['store_goods_index_pic_limit1']			= 'M，如果您想继续增加洗件，请到“店铺设置”升级店铺等级';
$lang['store_goods_index_time_limit']			= '您已经达到店铺使用期限，如果您想继续增加洗件，请到“店铺设置”升级店铺等级';
...
$lang['store_goods_index_goods_class_null']		= '洗件分类不能为空';
$lang['store_goods_index_goods_class_error']	= '选择洗件分类（必须选到最后一级）';
$lang['store_goods_index_goods_name_null']		= '洗件名称不能为空';
$lang['store_goods_index_store_price_null']		= '洗件价格不能为空';
$lang['store_goods_index_store_price_error']	= '洗件价格只能是数字';
$lang['store_goods_index_store_price_interval']	= '洗件价格必须是0.01~9999999之间的数字';
$lang['store_goods_index_goods_stock_null']		= '洗件库存不能为空';
$lang['store_goods_index_goods_stock_error']	= '库存只能填写数字';
$lang['store_goods_index_goods_weight_null']    = '洗件重量不能为空';
$lang['store_goods_index_edit_goods_spec']		= '编辑洗件规格';
...
$lang['store_goods_index_belong_multiple_store_class']	= '洗件可以从属于店铺的多个分类之下，店铺分类可以由 "商家中心 -> 店铺 -> 店铺分类" 中自定义';
$lang['store_goods_index_goods_base_info']		= '洗件基本信息';
$lang['store_goods_index_goods_detail_info']	= '洗件详情描述';
$lang['store_goods_index_goods_transport']		= '洗件物流信息';
...
$lang['store_goods_index_upload_goods_pic']		= '上传洗件图片';
...
$lang['store_goods_index_goods_brand']			= '洗件品牌';
$lang['store_goods_index_multiple_tag']			= '多个Tag标签请用半角逗号 "," 隔开';
$lang['store_goods_index_store_price']			= '洗件价格';
$lang['store_goods_index_store_price_help']		= '价格必须是0.01~9999999之间的数字';
$lang['store_goods_index_goods_stock']			= '洗件库存';
$lang['store_goods_index_goods_stock_checking']	= '商铺库存数量必须为0~999999999之间的整数';
$lang['store_goods_index_goods_stock_help']		= '商铺库存数量必须为0~999999999之间的整数';	//<br/>若启用了库存配置，则系统自动计算洗件的总数，此处无需卖家填写
...
$lang['store_goods_index_goods_no_help']		= '商家货号是指商家管理洗件的编号，买家不可见<br/>最多可输入20个字符，支持输入中文、字母、数字、_、/、-和小数点';
$lang['srore_goods_index_goods_stock_set']		= '库存配置';
$lang['store_goods_index_goods_spec']			= '洗件规格';
$lang['store_goods_index_open_spec']			= '开启规格';
$lang['store_goods_index_spec_tip']				= '您最多可以添加两种洗件规格（如：颜色，尺码）如洗件没有规格则不用添加';
$lang['store_goods_index_edit_spec']			= '编辑规格';
$lang['store_goods_index_close_spec']			= '关闭规格';
$lang['store_goods_index_goods_attr']			= '洗件属性';
$lang['store_goods_index_goods_show']			= '洗件发布';
$lang['store_goods_index_immediately_sales']	= '立即发布';
$lang['store_goods_index_in_warehouse']			= '放入仓库';
$lang['store_goods_index_goods_recommend']		= '洗件推荐';
$lang['store_goods_index_recommend_tip']		= '被推荐的洗件会显示在店铺首页';
$lang['store_goods_index_goods_desc']			= '洗件描述';
$lang['store_goods_index_upload_pic']			= '上传图片';
$lang['store_goods_index_spec']					= '规格';
$lang['store_goods_index_edit_goods']			= '编辑洗件';
$lang['store_goods_index_add_sclasserror']		= '该分类已经选择,请选择其他分类';
$lang['store_goods_index_goods_add_success']	= '洗件添加成功';
$lang['store_goods_index_goods_add_fail']		= '洗件添加失败';
$lang['store_goods_index_goods_edit_success']	= '洗件编辑成功';
$lang['store_goods_index_goods_edit_fail']		= '洗件编辑失败';
$lang['store_goods_index_goods_del_success']	= '洗件删除成功';
$lang['store_goods_index_goods_del_fail']		= '洗件删除失败';
$lang['store_goods_index_goods_unshow_success']	= '洗件下架成功';
$lang['store_goods_index_goods_unshow_fail']	= '洗件下架失败';
$lang['store_goods_index_goods_show_success']	= '洗件上架成功';
$lang['store_goods_index_goods_show_fail']		= '洗件上架失败';
...
$lang['store_goods_index_goods_seo_keywords_help']		= 'SEO关键字 (keywords) 出现在洗件详细页面头部的 Meta 标签中，<br/>用于记录本页面洗件的关键字，多个关键字间请用半角逗号 "," 隔开';
$lang['store_goods_index_goods_seo_description_help']   = 'SEO描述 (description) 出现在洗件详细页面头部的 Meta 标签中，<br/>用于记录本页面洗件内容的概要与描述，建议120字以内';
...
$lang['store_goods_index_flow_chart_step1']				= '选择洗件所在分类';
$lang['store_goods_index_flow_chart_step2']				= '填写洗件详细信息';
$lang['store_goods_index_flow_chart_step3']				= '洗件发布成功';
...
$lang['store_goods_step2_goods_form']					= '洗件类型';
...
$lang['store_goods_step2_spec_img_help']				= '支持jpg、jpeg、gif、png格式图片。<br />建议上传尺寸310x310、大小%.2fM内的图片。<br />洗件详细页选中颜色图片后，颜色图片将会在洗件展示图区域展示。';
$lang['store_goods_step2_description_one']				= '最多可发布5张洗件图片。';
$lang['store_goods_step2_description_one']				= '上传洗件默认主图，如多规格值时将默认使用该图或分规格上传各规格主图；支持jpg、gif、png格式上传或从图片空间中选择，建议使用<font color="red">尺寸800x800像素以上、大小不超过1M的正方形图片</font>，上传后的图片将会自动保存在图片空间的默认分类中。';
...
$lang['store_goods_step1_search_input_text']			= '请输入洗件名称或分类属性名称';
$lang['store_goods_step1_search']						= '搜索';
$lang['store_goods_step1_return_choose_category']		= '返回洗件分类选择';
$lang['store_goods_step1_search_null']					= '没有找到相关的洗件分类。';
$lang['store_goods_step1_searching']					= '搜索中...';
$lang['store_goods_step1_loading']						= '加载中...';
$lang['store_goods_step1_choose_common_category']		= '您常用的洗件分类：';
$lang['store_goods_step1_please_select']				= '请选择';
$lang['store_goods_step1_no_common_category']			= '您还没有添加过常用的分类';
$lang['store_goods_step1_please_choose_category']		= '请选择洗件类别';
$lang['store_goods_step1_current_choose_category']		= '您当前选择的洗件类别是';
 ...
 * 洗件发布第三步
 */
$lang['store_goods_step3_goods_release_success']		= '恭喜您，洗件发布成功！';
$lang['store_goods_step3_viewed_product']				= '去店铺查看洗件详情';
$lang['store_goods_step3_edit_product']					= '重新编辑刚发布的洗件';
$lang['store_goods_step3_more_actions']					= '您还可以:';
$lang['store_goods_step3_continue']						= '继续';
$lang['store_goods_step3_release_new_goods']			= '发布新洗件';
$lang['store_goods_step3_access']						= '进入';
$lang['store_goods_step3_manage']						= '管理';
$lang['store_goods_step3_choose_product_add']			= '选择洗件添加申请';
$lang['store_goods_step3_choose_add']					= '选择洗件参加';
...
$lang['store_goods_brand_upload_tip']			= '建议上传大小为88x44的品牌图片。<br />申请品牌的目的是方便买家通过品牌索引页查找洗件，申请时请填写品牌所属的类别，方便站长归类。在站长审核前，您可以编辑或撤销申请。';
...
$lang['store_goods_upload_pic_limit1']			= 'M，如果您想继续增加洗件，请到“店铺设置”升级店铺等级';
 ...
 * 相册
 */
$lang['store_goods_album_goods_pic']			= '洗件图片';
 ...
 * ajax
 */
$lang['store_goods_ajax_find_none_spec']		= '未找到洗件规格';
...
$lang['store_goods_import_wrong_class']		= '请选择洗件分类（必须选到最后一级）';
$lang['store_goods_import_wrong_class1']	= '该洗件分类不可用，请重新选择洗件分类（必须选到最后一级）';
...
$lang['store_goods_import_goods_class']		= '洗件分类：';
...
2.如果因为淘宝助理版本差异表头名称有出入，请先修改成上述的名称方可导入，不区分全新、二手、闲置等新旧程度，导入后洗件类型都是全新。<br/>
3.如果CSV文件超过'.ini_get('upload_max_filesize').'请通过excel软件编辑拆成多个文件进行导入。<br/>
4.每个洗件最多支持导入5张图片。';
$lang['store_goods_import_submit']			= '导入';
$lang['store_goods_import_step2']			= '第二步：上传洗件图片';
...
$lang['store_goods_import_products_no_import']	= '件洗件没有导入';
 ...
 * ajax修改洗件标题
 */
$lang['store_goods_title_change_tip']		= '单击修改洗件标题名称，长度<br/>至少3个字符，最长50个汉字';
 ...
 * ajax修改洗件推荐
 */
$lang['store_goods_commend_change_tip']		= '选择是否作为店铺推荐洗件';
