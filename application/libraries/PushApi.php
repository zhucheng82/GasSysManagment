<?php
    class PushApi{
    private $app_key = 'ffd6bef3f9fa7d4e6306fc3c';            //待发送的应用程序(appKey)，只能填一个。
    private $master_secret = 'fd8eb98d35e1777799d67e2a';        //主密码
    //private $app_key = 'cc74e1bcade09bb49ffab240';            //待发送的应用程序(appKey)，只能填一个。
    //private $master_secret = 'b89594c544c7418c4ad6389b';        //主密码
    ...
    */
    ...
    public function push($receiver='',$content='',$m_type='',$m_txt='',$m_time='86400',$m_title=''){
        ...
        $data['notification'] = array(
            ...
            "ios"=>array(
                ...
                "badge"=>"1",
                "sound"=> 'default',
                //"extras"=>array("type"=>$m_type, "custom_info"=>$m_txt)
                "extras"=>array("custom_info"=>json_decode($m_txt))
            ),
        );
