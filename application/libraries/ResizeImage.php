...
class ResizeImage{
	 ...
	 * $resizeImage->newImg($save_path.'/'.$this->file_name,$thumb_width,$thumb_height,$scale,$thumb_ext[$i].'.',$save_path);
	 * 
...
//		}
	...
	private function dst_img()
	{
		...
		$this->relative_dstimg = str_replace(BASE_ROOT_PATH,'',$this->dstimg);
	}
}