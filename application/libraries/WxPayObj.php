...
class WxPayDataBase
{
	...
	**/
    ...
    public function MakeSign()
    {
        ...
        if(!empty($this->values['appid']))
            $AppId = $this->values['appid'];
        if(!empty($this->values['mch_appId']))
            $AppId = $this->values['mch_appId'];
        if(!empty($this->values['mch_appid']))
            $AppId = $this->values['mch_appid'];
        if($AppId==getWxappIDByType())
            $WxKEY = getWxKEYByType();
        else
            $WxKEY = PayConfig::WapWxKEY;
 ...
 *
 */
class WxPayJsApiPayObj extends WxPayDataBase
{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
 ...
 *
 */
class WxPayAppPayObj extends WxPayDataBase
{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
