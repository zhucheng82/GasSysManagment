...
//include('./WebUtil.php');
/*
include('../application/libraries/zmxy-sdk/zmop/RSAUtil.php');
include('../application/libraries/zmxy-sdk/zmop/WebUtil.php');
*/
class ZmopClient {
	//应用ID
	public $appId;
...
*/
    ...
    function __construct($config = array()){
        ...
        $this -> privateKeyFilePath = $config['privateKeyFilePath'];
        $this->  zhiMaPublicKeyFilePath = $config['zhiMaPublicKeyFilePath'];
	...
	public function generateSignWithUrlEncode($request){
		$paramStr = $this->generateSign($request);
