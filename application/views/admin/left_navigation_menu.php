...
<script type="text/javascript">
    $(function(){
        ...
        function showRightContent(type, company_id, meter_eui) {
            ...
            var data = {'type':type, 'company_id':company_id,'meter_eui':meter_eui};

            $.ajax({
                type:"POST",
                url:'<?php echo ADMIN_SITE_URL.'/home/getMeterStatisticalInfoWithLevel'?>',
                cache:false,
                data: data,
