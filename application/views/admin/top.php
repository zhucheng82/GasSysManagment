...
<head>
    ...
    <link rel="stylesheet" href="/res/font/font-awesome/css/font-awesome.css" />
...
<body style="min-width: 600px; margin: 10px; ">
    ...
    <div class="container-fluid">
        ...
        <div>
            ...
            <ul class="nav nav-pills">
                ...
                <li <?php if(isset($index) && $index == 4) echo 'class="active"'; ?> ><a <?php if(isset($index) && $index == 4) echo 'href="#"';else echo 'href='.BASE_SITE_URL.'/admin/home/test'; ?> data-toggle="tab">测试</a> </li>
            </ul>
