...
function ajaxFileUpload(id, o) {
    $('img[nctype="' + id + '"]').attr('src', SHOP_RESOURCE_SITE_URL + "/images/loading.gif");
    ...
    $.ajaxFileUpload({
        ...
        success : function (data, status) {
                    ...
                    $.getScript(SHOP_RESOURCE_SITE_URL+ 'js/shop_goods_add.step3.js');
                },
...
function insert_img(name, src) {
    var $_thumb = $('ul[nctype="ul"]').find('.upload-thumb');
